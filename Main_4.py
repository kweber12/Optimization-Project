"""
This file runs and stores the data for part 4
"""
import pandas as pn
...
for c in combos:
    for i in range(trials):
        (x, f_rec, norm_grad_rec,k,t) = f.SLBFGS(function_1,total_dat,function_1g, x0, stepMethods[c[0]], batchSizes[c[1]], max_i)
        print(c)
        print(i)
        print(x)
        xs[c[0],c[1],i]=x
